#!/bin/bash
#SBATCH --job-name=multiqc.sh                      # Job name
...
#SBATCH --output=/work/gene8940/bgf57696/rpx-rnaseq/fastqc_results/outlogs/%x_%j.out  # Standard output log, e.g., testBowtie2_12345.out
...
#set output variable
OUTDIR=/work/gene8940/bgf57696/rpx-rnaseq/fastqc_results/multiqc/

multiqc --file-list fastq_list.txt --outdir .
