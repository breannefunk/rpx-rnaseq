...
#SBATCH --output=/work/gene8940/bgf57696/rpx-rnaseq/rnaseq_sra/%x_%j.out  # Standard output log, e.g., testBowtie2_12345.out
#SBATCH --mail-user=bgf57696@uga.edu                # Where to send mail
#SBATCH --mail-type=ALL                        # Mail events (BEGIN, END, FAIL, ALL)

OUTDIR=/work/gene8940/bgf57696/rpx-rnaseq/rnaseq_sra/
cd $OUTDIR
...
#convert to FASTQ
fastq-dump --split-files --gzip -O $OUTDIR $SRR

#paired vs. single runs
